<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- Non-streamable absorbing function call - argument is crawling -->
  
  <xsl:function name="f:get-inherited-attribute-value-004"  streamability="absorbing">
  ...
  <xsl:template name="main" >
    <xsl:source-document streamable="yes" href="../docs/books.xml">
      <out>
        <xsl:sequence select="f:get-inherited-attribute-value-004(//*, 'CAT')"/>
      </out>
    </xsl:source-document>
  </xsl:template>

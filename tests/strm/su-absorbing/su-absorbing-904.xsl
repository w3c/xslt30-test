<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- Non-streamable absorbing function call - supplies streamed node in second argument -->
  
  <xsl:function name="f:get-inherited-attribute-value-004" as="xs:string?" streamability="absorbing">

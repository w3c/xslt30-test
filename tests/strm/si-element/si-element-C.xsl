<xsl:stylesheet version="3.0" 
    ...
    <xsl:template name="s-003" use-when="$RUN">
      <xsl:stream href="../docs/books.xml">
        <out>
          <xsl:element name="a"><xsl:sequence select="./BOOKLIST/BOOKS/ITEM/PRICE"/></xsl:element>
        </out>
      </xsl:stream>
    </xsl:template>
    ...
    <xsl:template name="s-004" use-when="$RUN">
      <xsl:stream href="../docs/books.xml">
        <out>
          <xsl:element name="a"><xsl:sequence select="./BOOKLIST/BOOKS/ITEM[@CAT='P']/PRICE"/></xsl:element>
        </out>
      </xsl:stream>
    </xsl:template>
    ...
    <xsl:template name="s-005" use-when="$RUN">
      <xsl:stream href="../docs/books.xml">
        <out>
          <xsl:element name="a"><xsl:sequence select="./BOOKLIST/BOOKS/ITEM[position() lt 4]/PRICE"/></xsl:element>
        </out>
      </xsl:stream>
    </xsl:template>
    ...
    <xsl:template name="s-006" use-when="$RUN">
      <xsl:stream href="../docs/books.xml">
        <out>
          <xsl:element name="a"><xsl:sequence select="./BOOKLIST/BOOKS/*[position() lt 4]/PRICE"/></xsl:element>
        </out>
      </xsl:stream>
    </xsl:template>
    ...
    <xsl:template name="s-008" use-when="$RUN">
      <xsl:stream href="../docs/books.xml">
        <out>
          <xsl:element name="a"><xsl:sequence select="./BOOKLIST/BOOKS/ITEM/PAGES/data()[. &lt; 1000][. &gt; 0]"/></xsl:element>
        </out>
      </xsl:stream>
    </xsl:template>
    ...
    <xsl:template name="s-009" use-when="$RUN">
      <xsl:stream href="../docs/books.xml">
        <out>
          <xsl:element name="a"><xsl:sequence select="BOOKLIST/BOOKS/ITEM/PAGES/text()[. &lt; 1000][. &gt; 0]"/></xsl:element>
        </out>
      </xsl:stream>
    </xsl:template>
    ...
    <xsl:template name="s-010" use-when="$RUN">
      <xsl:stream href="../docs/books.xml">
        <out>
          <xsl:element name="a"><xsl:sequence select="/BOOKLIST/BOOKS/ITEM/PAGES/number()[. &lt; 1000][. &gt; 0]"/></xsl:element>
        </out>
      </xsl:stream>
    </xsl:template>
    ...
    <xsl:template name="s-011" use-when="$RUN">
      <xsl:stream href="../docs/books.xml">
        <out>
          <xsl:element name="a"><xsl:sequence select="ITEM/PAGES"/></xsl:element>
        </out>
      </xsl:stream>
    </xsl:template>
    ...
    <xsl:template name="s-012" use-when="$RUN">
      <xsl:stream href="../docs/books.xml">
        <out>
          <xsl:element name="a"><xsl:sequence select="./BOOKLIST/BOOKS/ITEM/PAGES/number(), 31, 32"/></xsl:element>
        </out>
      </xsl:stream>
    </xsl:template>
    ...
    <xsl:template name="s-013" use-when="$RUN">
      <xsl:stream href="../docs/books.xml">
        <out>
          <xsl:element name="a"><xsl:sequence select="tail(./BOOKLIST/BOOKS/ITEM/PAGES)/number(), 31, 32"/></xsl:element>
        </out>
      </xsl:stream>
    </xsl:template>   
    ...
    <xsl:template name="s-016" use-when="$RUN">
      <xsl:stream href="../docs/big-transactions.xml">
        <out>
          <xsl:element name="a"><xsl:sequence select="account/transaction[position() lt 5]/(@value*2)"/></xsl:element>
        </out>
      </xsl:stream>
    </xsl:template>
    ...
    <xsl:template name="s-017" use-when="$RUN">
      <xsl:stream href="../docs/books.xml">
        <out>
          <xsl:element name="a"><xsl:sequence select="./BOOKLIST/BOOKS/ITEM/PAGES/copy-of()[. &lt; 1000][. &gt; 0]"/></xsl:element>
        </out>
      </xsl:stream>
    </xsl:template>
    ...
    <xsl:template name="s-018" use-when="$RUN">
      <xsl:stream href="../docs/big-transactions.xml">
        <out>
          <xsl:element name="a"><xsl:sequence select="account/transaction[position() lt 5]/@value"/></xsl:element>
        </out>
      </xsl:stream>
    </xsl:template>
    ...
    <xsl:template name="s-019" use-when="$RUN">
      <xsl:stream href="../docs/big-transactions.xml">
        <out>
          <xsl:element name="a"><xsl:sequence select="account/transaction/@value[xs:decimal(.) lt -8.00]"/></xsl:element>
        </out>
      </xsl:stream>
    </xsl:template> 
    ...
    <xsl:template name="s-020" use-when="$RUN">
      <xsl:stream href="../docs/big-transactions.xml">
        <out>
          <xsl:element name="a"><xsl:sequence select="account/transaction[position() mod 10 = 1]/abs(@value)"/></xsl:element>
        </out>
      </xsl:stream>
    </xsl:template>
    ...
    <xsl:template name="s-022" use-when="$RUN">
      <xsl:stream href="../docs/books.xml">
        <out>
          <xsl:element name="a"><xsl:sequence select="BOOKLIST/BOOKS/ITEM/DIMENSIONS!xs:NMTOKENS(.)!xs:decimal(.)"/></xsl:element>
        </out>
      </xsl:stream>
    </xsl:template>
    ...
    <xsl:template name="s-023" use-when="$RUN">
      <xsl:stream href="../docs/books.xml">
        <out>
          <xsl:element name="a"><xsl:sequence select="outermost(//ITEM/DIMENSIONS)!xs:NMTOKENS(.)!xs:decimal(.)"/></xsl:element>
        </out>
      </xsl:stream>
    </xsl:template>
    ...
    <xsl:template name="s-040" use-when="$RUN">
      <xsl:stream href="../docs/books.xml">
        <out>
          <xsl:element name="a"><xsl:sequence select="data(/*/*/NOTHING)"/></xsl:element>
        </out>
      </xsl:stream>
    </xsl:template>
    ...
    <xsl:template name="s-041" use-when="$RUN">
      <xsl:stream href="../docs/books.xml">
        <out>
          <xsl:element name="a"><xsl:sequence select="/BOOKLIST/BOOKS/MAGAZINE"/></xsl:element>
        </out>
      </xsl:stream>
    </xsl:template>
    ...
    <xsl:template name="s-042" use-when="$RUN">
      <xsl:stream href="../docs/books.xml">
        <out>
          <xsl:element name="a"><xsl:sequence select="//MAGAZINE"/></xsl:element>
        </out>
      </xsl:stream>
    </xsl:template>
    ...
    <xsl:template name="s-043" use-when="$RUN">
      <xsl:stream href="../docs/books.xml">
        <out>
          <xsl:element name="a"><xsl:sequence select="//PRICE/../@nothing"/></xsl:element>
        </out>
      </xsl:stream>
    </xsl:template>
    ...
    <xsl:template name="s-048" use-when="$RUN">
      <xsl:stream href="../docs/books.xml">
        <out>
          <xsl:element name="a" namespace="http://{lower-case(translate(head(//AUTHOR), ' ', '_'))}.com/">value</xsl:element>
        </out>
      </xsl:stream>
    </xsl:template>
    ...
    <xsl:template name="s-050" use-when="$RUN">
      <xsl:stream href="../docs/books.xml">
        <out>
          <xsl:element name="a" on-empty="()"><xsl:sequence select="./BOOKLIST/BOOKS/ITEM/PRICE/data()"/></xsl:element>
        </out>
      </xsl:stream>
    </xsl:template>
    ...
    <xsl:template name="s-051" use-when="$RUN">
      <xsl:stream href="../docs/books.xml">
        <out>
          <xsl:element name="a" on-empty="()"><xsl:sequence select="./BOOKLIST/BOOKS/ITEM/PRICETAG"/></xsl:element>
        </out>
      </xsl:stream>
    </xsl:template>
    ...
    <xsl:template name="s-052" use-when="$RUN">
      <xsl:stream href="../docs/books.xml">
        <out>
          <xsl:element name="a" on-empty="head(//*)"><xsl:sequence select="1 to 10"/></xsl:element>
        </out>
      </xsl:stream>
    </xsl:template>
    ...
    <xsl:template name="s-053" use-when="$RUN">
      ...
      <xsl:stream href="../docs/books.xml">
        <out>
          <xsl:element name="a" on-empty="head(//TITLE)"><xsl:sequence select="$s to 10"/></xsl:element>
        </out>
      </xsl:stream>
    </xsl:template>
    ...
    <xsl:template name="s-054" use-when="$RUN">
      ...
      <xsl:stream href="../docs/books.xml">
        <xsl:for-each select="BOOKLIST/BOOKS">
          <out>
            <xsl:element name="a" on-empty="$e"><xsl:sequence select="ITEM/PRICETAG"/></xsl:element>
          </out>
        </xsl:for-each>  
      </xsl:stream>
    </xsl:template>
    
    <!-- Test of xsl:stream with xsl:element/@on-empty (empty, type error, returns two elements) -->
    ...
    <xsl:template name="s-055" use-when="$RUN">
      ...
      <xsl:stream href="../docs/books.xml">
        <xsl:for-each select="BOOKLIST/BOOKS">
          <out>
            <xsl:element name="a" on-empty="$atts"><xsl:sequence select="ITEM/PRICETAG"/></xsl:element>
          </out>
        </xsl:for-each>  
      </xsl:stream>
    </xsl:template>
    
    <!-- Test of xsl:stream with xsl:element/@on-empty (empty, type error, returns two elements, recovered) -->
          ...
          <out>
            <xsl:try>
              ...
              <xsl:catch errors="*:XTTE3310">
                <xsl:element name="fallback">OK</xsl:element>
              </xsl:catch>
            </xsl:try>  
          </out>
        </xsl:for-each>  
    ...
    <xsl:template name="s-057" use-when="$RUN">
      ...
      <xsl:stream href="../docs/books.xml">
        <out>
          <xsl:element name="a"><xsl:sequence select="1, 2, head(//text()), $s"/></xsl:element>
        </out>
      </xsl:stream>
    </xsl:template>
    ...
    <xsl:template name="s-059" use-when="$RUN">
      ...
      <xsl:stream href="../docs/books.xml">
        <out>
          <xsl:element name="{$s}"><xs:sequence select="1, 2, head(//text())"/></xsl:element>
        </out>
      </xsl:stream>
    </xsl:template>
    ...
    <xsl:template name="s-060" use-when="$RUN">
      ...
      <xsl:stream href="../docs/books.xml">
        <out>
          <xsl:try>
            <xsl:element name="{$s}"><xsl:sequence select="1, 2, head(//text())"/></xsl:element>
    ...
    <xsl:template name="s-065" use-when="$RUN">
      ...
      <xsl:stream href="../docs/books.xml">
        <out>
          <xsl:element name="a:b" namespace="{$s}"><xsl:sequence select="1, 2, head(//text())"/></xsl:element>
        </out>
      </xsl:stream>
    </xsl:template>

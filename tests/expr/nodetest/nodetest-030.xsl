...
<t:transform xmlns:my="http://www.schemanodetest.example.com/ns/various"
             ...
             version="2.0">
<!-- Purpose: Test schema-attribute($name) as the last step in a path expression.-->
   ...
   <t:template match="/">
	     <out>
         <t:value-of select="my:userNode/my:complexSimpleContentElem/schema-attribute(my:count)"/>
      </out>
   </t:template>
</t:transform>

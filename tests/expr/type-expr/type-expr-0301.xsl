   ...
   <xslt:template match="/my:userNode">
      <out>
         ...
         <types>
            ...
            <xslt:value-of select="data(elem-duration-derived[1]) instance of my:elem-duration-derived-Type"/>
            <xslt:value-of select="data(elem-duration-derived[2]) instance of xs:duration"/>
            <xslt:value-of select="data(elem-duration-derived[2]) instance of my:elem-duration-derived-Type"/>
            <xslt:value-of select="data(elem-duration-derived[3]) instance of xs:duration"/>
            <xslt:value-of select="data(elem-duration-derived[3]) instance of my:elem-duration-derived-Type"/>
         </types>
         <xslt:text>
</xslt:text>
         <e1>

...
<out>
    ...
    <a0 ans="{round-half-to-even($small, 40)}"/> 
    <aa ans="{round-half-to-even($small, 4)}"/> 
    <ab ans="{round-half-to-even($small, 1)}"/> 
    <ac ans="{round-half-to-even($small, 0)}"/> 
    <ad ans="{round-half-to-even($small, -1)}"/> 
    <ae ans="{round-half-to-even($small, -10)}"/> 
    <af ans="{round-half-to-even($small, -30)}"/> 
    <ag ans="{round-half-to-even($small, -100)}"/> 
 </out>
</xsl:template>
</xsl:stylesheet>
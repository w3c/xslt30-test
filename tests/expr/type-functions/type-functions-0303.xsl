   ...
   <xslt:template match="/my:userNode">
      <out>
         ...
         <e11>
            ...
            <xslt:text> , </xslt:text>
            <xslt:value-of
               select="matches(elem-normalizedString-derived, elem-normalizedString-derived)"/>
         </e11>
         <e12>
         ...
         <e17>
            ...
            <xslt:text> , </xslt:text>
            <xslt:value-of
               select="matches(elem-ID-attr-derived/@attr1, elem-ID-attr-derived/@attr1)"/>
         </e17>
         <e18>
            ...
            <xslt:text> , </xslt:text>
            <xslt:value-of
               select="matches(elem-IDREF-attr-derived/@attr1, elem-IDREF-attr-derived/@attr1)"/>
         </e18>
      </out>
   </xslt:template>
</xslt:transform>

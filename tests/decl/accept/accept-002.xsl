<!-- xsl:accept - reduce the visibility to private. Components are still accessible -->

<xsl:package
  name="http://www.w3.org/xslt30tests/accept-002"  
  ...
  <xsl:use-package
    ...
    <xsl:accept component="attribute-set" names="*" visibility="private"/>

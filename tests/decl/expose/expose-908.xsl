<!-- xsl:expose - error, cannot change visibility of xsl:param -->

<xsl:package
  name="http://www.w3.org/xslt30tests/package-908"  
  ...
  <xsl:accumulator name="acc" initial-value="0">
    ...
    <xsl:expose visibility="final" component="variable" names="p"/>

...
<xsl:package
  name="http://www.w3.org/xslt30tests/package-912b"  
  ...
  <xsl:function name="p:f1" visibility="private"><xsl:sequence select="0"/></xsl:function>
  <xsl:function name="p:f1" visibility="private"><xsl:param name="x"/><xsl:sequence select="0"/></xsl:function>
  <xsl:function name="p:f1" visibility="private"><xsl:param name="x"/><xsl:param name="y"/><xsl:sequence select="0"/></xsl:function>
  ...
  <xsl:accumulator name="acc" initial-value="0">
    ...
    <xsl:expose visibility="private" component="function" names="p:f2"/>
    <xsl:expose visibility="abstract" component="function" names="p:f1"/>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   xmlns:foo="http://ns.example.com/sch002" exclude-result-prefixes="foo" version="2.0">

   <!-- Purpose: Test where a schema is imported in an imported stylesheet of an included stylesheet but datatypes are used in the primary stylesheet.-->

   <xsl:include href="import-schema-171a.xsl"/>

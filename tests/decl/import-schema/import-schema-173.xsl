...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- Purpose: Test for importing one and the same schema several times.Whichever comes second 
  				should be ignored, no error should be raised for component conflicts.-->

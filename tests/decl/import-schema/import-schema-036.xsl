...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
        ...
        xmlns:enu="http://schema045.uri/"
        exclude-result-prefixes="xs enu">

<!-- PURPOSE: Test use of union type with named types as the union members -->
<?spec xslt#validation-xsl-type?>
<?spec xslt#annotation-for-constructed-attribute?>

<xsl:import-schema schema-location="schema045.xsd" 
     namespace="http://schema045.uri/"/>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- Purpose: Test where two different schemas are imported, one in the primary and one 
  				in the included stylesheet. Show that datatypes from both schemas can be 
  				used in both stylesheets.-->

   <xsl:include href="import-schema-186a.xsl"/>

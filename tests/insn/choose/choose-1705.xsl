...
<xslt:transform xmlns:xs="http://www.w3.org/2001/XMLSchema"
                ...
                version="2.0">
<!-- Purpose: Test case in which the operand of the test attribute in the xsl:when instruction is a 
  				sequences of node, zero-length strings and numeric zeroe in one instance and a 

...
<xslt:transform xmlns:xs="http://www.w3.org/2001/XMLSchema"
                ...
                version="2.0">
<!-- Purpose: Test of xsl:next-match for two templates, one with pattern "attribute()" 
				and the other one with pattern "attribute(*, xs:untypedAtomic)".-->
   ...
   <xslt:template match="attribute(*, xs:untypedAtomic)">

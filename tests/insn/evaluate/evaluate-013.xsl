...
<!-- show schema declarations are not available if schema-aware = absent -->

<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:ev28="http://example.com/evaluate99028b" version="3.0"
exclude-result-prefixes="xs ev28">

  <xsl:output method="xml" encoding="UTF-8"/>
  
  <xsl:import-schema>
    <xs:schema targetNamespace="http://example.com/evaluate99028b">
  ...
  <xsl:template match="/" name="main">
    <Result>
      ...
      <value>
         <xsl:evaluate xpath="$path" as="xs:boolean">

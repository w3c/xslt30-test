...
STATIC setting2=[value2]
    ...
    <a>DYNAMIC(A-all) setting1=[<xsl:value-of select="my:evaluate(concat('$p1/',$name1,'/@v'),$settingsall)"/>]</a>
    <a>DYNAMIC(A-all) setting2=[<xsl:value-of select="my:evaluate(concat('$p1/',$name2,'/@v'),$settingsall)"/>]</a>
...
DYNAMIC(A-all) setting2=[value2]
    ...
    <d>DYNAMIC(B-top) setting1=[<xsl:value-of select="my:evaluate(concat('$p1/',$name1,'/@v'),$settingstop/settings)"/>]</d>
    <d>DYNAMIC(B-top) setting2=[<xsl:value-of select="my:evaluate(concat('$p1/',$name2,'/@v'),$settingstop/settings)"/>]</d>
    <d>DYNAMIC(B-1) setting1=[<xsl:value-of select="my:evaluate(concat('$p1/',$name1,'/@v'),$settings1/settings)"/>]</d>
    <d>DYNAMIC(B-2) setting2=[<xsl:value-of select="my:evaluate(concat('$p1/',$name2,'/@v'),$settings2/settings)"/>]</d>
    ...
    <g>DYNAMIC(C-top) setting1=[<xsl:value-of select="my:evaluate(concat('$p1/',$name1,'/@v'),$settingstoprev/settings)"/>]</g>
    <g>DYNAMIC(C-top) setting1=[<xsl:value-of select="my:evaluate(concat('$p1/',$name2,'/@v'),$settingstoprev/settings)"/>]</g>


    <!--dynamic fetching of values from other ways to specify the nodes-->
    
    <h>DYNAMIC(D) setting1=[<xsl:value-of select="my:evaluate(concat('$p1[name()=',$apos,$name1,$apos,']/@v'),($settings1 | $settings2)/settings/*)"/>]</h>
    <h>DYNAMIC(D) setting1=[<xsl:value-of select="my:evaluate(concat('$p1[name()=',$apos,$name2,$apos,']/@v'),($settings1 | $settings2)/settings/*)"/>]</h>

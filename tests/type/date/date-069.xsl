...
<?spec fo#func-add-dayTimeDuration-to-date?>
<?spec fo#func-add-yearMonthDuration-to-date?>


  <!-- PURPOSE: XSLT 2.0: test date +/- duration -->

<xsl:param name="date" select="xs:date('2004-02-29')"/>
<xsl:param name="d5" select="xs:dayTimeDuration('P5D')"/>
<xsl:param name="d-5" select="xs:dayTimeDuration('-P5D')"/>

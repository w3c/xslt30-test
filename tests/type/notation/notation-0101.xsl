...
<xslt:transform xmlns:xs="http://www.w3.org/2001/XMLSchema"
                ...
                version="2.0">
<!-- Purpose: Test that the result of 'eq' on xs:NOTATION type arguments is of type xs:boolean. 
   ...
   <xslt:template match="/">
      <out>
         ...
         <xslt:value-of select="($v eq doc/sub/@filetype) instance of xs:boolean"/>
      </out>
   </xslt:template>
</xslt:transform>

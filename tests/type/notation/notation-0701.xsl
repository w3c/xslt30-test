...
<t:transform xmlns:one="http://notation.example.com"
             ...
             version="2.0">
<!-- Purpose: Test 'eq' with two attributes of two different types derived from xs:NOTATION defined in separate schemas, 
   ...
   <t:template match="/one:NOTATION-enumeration">
      <out>
         ...
         <t:text> * </t:text>
         <t:value-of select="data(one:NOTATION-element/@NOTATION-attribute) eq data(two:doc/sub/@filetype)"/>
      </out>
   </t:template>
</t:transform>

...
<!--
Error on line 28 of ... type956err.xsl:
  XTTE0505: Required item type of result of template match="/" is
  document-node(element(xhtml, xs:anyType)); supplied value has item type
  document-node(element(html, xs:anyType))
-->  

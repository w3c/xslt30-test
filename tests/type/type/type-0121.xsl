...
xmlns:xs="http://www.w3.org/2001/XMLSchema">
  ...
  <!-- PURPOSE: Test "instance of" with occurrence counts producing false. -->
  ...
  <xsl:template match="/">
    <out>;
      <t><xsl:value-of select="() instance of xs:decimal"/></t>;
      <t><xsl:value-of select="() instance of xs:boolean +"/></t>;

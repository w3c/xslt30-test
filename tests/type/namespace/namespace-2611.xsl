<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
		xmlns:dbf="http://nwalsh.com/docbook/xsl/functions"
...
<xsl:template match="/">
  <x>
    ...
    <m><xsl:value-of select="string(dbf:node-matches1($t,$d))"/></m>
    <m><xsl:value-of select="string(dbf:node-matches($t,$d))"/></m>

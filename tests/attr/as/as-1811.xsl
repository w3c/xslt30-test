...
<!-- Purpose: Test of xsl:template which contains a typed element node from input file, 
   ...
   <xslt:template name="temp2" as="element(*, my:personType)">
	  <my:complexUserElem xslt:type="my:personType" age="75"><firstName>Hello</firstName>
   ...
   <xslt:template name="temp3" as="element(*, my:mixedPersonType)">
	     <xslt:element name="my:complexMixedUserElem" validation="strict">
		       ...
		       <xslt:element name="description">Mr
			<xslt:element name="name">Peter</xslt:element>
			has brown hair
		</xslt:element>
		       <xslt:element name="company">He works at a 
			<xslt:element name="name">Notorios</xslt:element>
			 company
		</xslt:element>
	     </xslt:element>

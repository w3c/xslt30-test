...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<!-- Purpose: Test with global xsl:param where @select is xs:untypedAtomic or a typed 
	...
	<xsl:param name="par3" select="/doc-schemaas/elem-nonPositiveInteger" as="xs:nonPositiveInteger"/>

...
<xsl:variable name="v17" select="if (/doc-schemaas/elem-QName instance of element(*,xs:untyped)) then resolve-QName(/doc-schemaas/elem-QName,/doc-schemaas/elem-QName) else /doc-schemaas/elem-QName" as="xs:QName"/>
...
<xsl:variable name="v27" select="/doc-schemaas/elem-nonPositiveInteger" as="xs:nonPositiveInteger"/>
<xsl:variable name="v28" select="/doc-schemaas/elem-positiveInteger" as="xs:positiveInteger"/>
<xsl:variable name="v29" select="/doc-schemaas/elem-nonNegativeInteger" as="xs:nonNegativeInteger"/>

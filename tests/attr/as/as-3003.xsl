      ...
      <out>
         <xslt:apply-templates>
	           <xslt:with-param name="par1"
                             select="/my:userNode/my:list-builtin"
                             as="element(*, xs:NMTOKENS)"
                             tunnel="yes"/>
	           <xslt:with-param name="par2"
                             select="/my:userNode/my:list-primitive"
                             as="element(*, my:myPrimitiveListType)"
                             tunnel="yes"/>
	           <xslt:with-param name="par3"
                             select="/my:userNode/my:list-derived"
                             as="element(*, my:myDerivedListType)"
                             tunnel="yes"/>
	           <xslt:with-param name="par4"
                             select="/my:userNode/my:list-user-defined"
                             as="element(*, my:myListType)"
                             tunnel="yes"/>
	           <xslt:with-param name="par5"
                             select="/my:userNode/my:list-union"

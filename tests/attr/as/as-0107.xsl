...
<xslt:transform xmlns:xs="http://www.w3.org/2001/XMLSchema"
                ...
                version="2.0">
<!-- Purpose: Test of two xsl:templates, one contains a sequence of several explicitly 
  				constructed different built-in types and the other contains an empty sequence, 
  				both have @as="xs:anyAtomicType*". -->

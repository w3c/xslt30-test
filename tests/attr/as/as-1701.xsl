...
<!-- Purpose: Test with global xsl:variable where @select is a typed value obtained at run time 
   ...
   <xslt:variable name="var2"
                  select="/doc-schemaas/elem-base64Binary"
                  as="xs:anyAtomicType"/>

   <xslt:variable name="var3"
                  select="/doc-schemaas/elem-boolean"
                  as="xs:anyAtomicType"/>

   <xslt:variable name="var4" select="/doc-schemaas/elem-date" as="xs:anyAtomicType"/>

   <xslt:variable name="var5"
                  select="/doc-schemaas/elem-dateTime"
                  as="xs:anyAtomicType"/>

   <xslt:variable name="var6"
                  select="/doc-schemaas/elem-decimal"
                  as="xs:anyAtomicType"/>

   <xslt:variable name="var7"
                  select="/doc-schemaas/elem-double"
                  as="xs:anyAtomicType"/>

   <xslt:variable name="var8"
                  select="/doc-schemaas/elem-duration"
                  as="xs:anyAtomicType"/>
   ...
   <xslt:variable name="var11"
                  select="/doc-schemaas/elem-gMonth"
                  as="xs:anyAtomicType"/>

   <xslt:variable name="var12"
                  select="/doc-schemaas/elem-gMonthDay"
                  as="xs:anyAtomicType"/>

   <xslt:variable name="var13"
                  select="/doc-schemaas/elem-gYear"
                  as="xs:anyAtomicType"/>

   <xslt:variable name="var14"
                  select="/doc-schemaas/elem-gYearMonth"
                  as="xs:anyAtomicType"/>

   <xslt:variable name="var15"
                  select="/doc-schemaas/elem-hexBinary"
                  as="xs:anyAtomicType"/>

   <xslt:variable name="var16"
                  select="/doc-schemaas/elem-integer"
                  as="xs:anyAtomicType"/>

   <xslt:variable name="var17"
                  select="/doc-schemaas/elem-QName"
                  as="xs:anyAtomicType"/>

   <xslt:variable name="var18"
                  select="/doc-schemaas/elem-string"
                  as="xs:anyAtomicType"/>

   <xslt:variable name="var19" select="/doc-schemaas/elem-time" as="xs:anyAtomicType"/>

   <xslt:variable name="var20"
                  select="/doc-schemaas/elem-normalizedString"
                  as="xs:anyAtomicType"/>

   <xslt:variable name="var21"
                  select="/doc-schemaas/elem-token"
                  as="xs:anyAtomicType"/>

   <xslt:variable name="var22"
                  select="/doc-schemaas/elem-language"
                  as="xs:anyAtomicType"/>

   <xslt:variable name="var23" select="/doc-schemaas/elem-Name" as="xs:anyAtomicType"/>

   <xslt:variable name="var24"
                  select="/doc-schemaas/elem-NCName"
                  as="xs:anyAtomicType"/>

   <xslt:variable name="var25"
                  select="/doc-schemaas/elem-NMTOKEN"
                  as="xs:anyAtomicType"/>

   <xslt:variable name="var26" select="/doc-schemaas/elem-int" as="xs:anyAtomicType"/>

   <xslt:variable name="var27"
                  select="/doc-schemaas/elem-nonPositiveInteger"
                  as="xs:anyAtomicType"/>

   <xslt:variable name="var28"
                  select="/doc-schemaas/elem-positiveInteger"
                  as="xs:anyAtomicType"/>

   <xslt:variable name="var29"
                  select="/doc-schemaas/elem-nonNegativeInteger"
                  as="xs:anyAtomicType"/>

   <xslt:variable name="var30"
                  select="/doc-schemaas/elem-negativeInteger"
                  as="xs:anyAtomicType"/>

   <xslt:variable name="var31" select="/doc-schemaas/elem-long" as="xs:anyAtomicType"/>

   <xslt:variable name="var32"
                  select="/doc-schemaas/elem-unsignedLong"
                  as="xs:anyAtomicType"/>

   <xslt:variable name="var33"
                  select="/doc-schemaas/elem-unsignedInt"
                  as="xs:anyAtomicType"/>

   <xslt:variable name="var34"
                  select="/doc-schemaas/elem-short"
                  as="xs:anyAtomicType"/>

   <xslt:variable name="var35"
                  select="/doc-schemaas/elem-unsignedShort"
                  as="xs:anyAtomicType"/>

   <xslt:variable name="var36" select="/doc-schemaas/elem-byte" as="xs:anyAtomicType"/>

   <xslt:variable name="var37"
                  select="/doc-schemaas/elem-unsignedByte"
                  as="xs:anyAtomicType"/>

   <xslt:variable name="var38"
                  select="/doc-schemaas/elem-ID-attr/@attr1"
                  as="xs:anyAtomicType"/>

   <xslt:variable name="var39"
                  select="/doc-schemaas/elem-IDREF-attr/@attr1"
                  as="xs:anyAtomicType"/>

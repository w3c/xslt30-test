...
<xslt:transform xmlns:xs="http://www.w3.org/2001/XMLSchema"
                xmlns:my="http://www.example.com/ns/integer"
...
<!-- Purpose: Test type of global xsl:variable where @select contains a user-defined value derived by 
   ...
   <xslt:variable name="var1"
                  select="/my:integer-main/i1-integer-enumeration"
                  as="xs:decimal"/>

   <xslt:variable name="var2"
                  select="/my:integer-main/i2-integer-maxExclusive-minExclusive"
                  as="xs:decimal"/>

   <xslt:variable name="var3"
                  select="/my:integer-main/i3-integer-maxInclusive-minInclusive"
                  as="xs:decimal"/>

   <xslt:variable name="var4"
                  select="/my:integer-main/i4-integer-pattern"
                  as="xs:decimal"/>

   <xslt:variable name="var5"
                  select="/my:integer-main/i5-integer-fractionDigits-totalDigits"
                  as="xs:decimal"/>

   <xslt:variable name="var6"
                  select="/my:integer-main/i6-integer-whiteSpace"
                  as="xs:decimal"/>

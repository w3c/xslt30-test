...
<xslt:transform xmlns:xs="http://www.w3.org/2001/XMLSchema"
                xmlns:my="http://www.example.com/ns/anyuri"
...
<!-- Purpose: Test type of global xsl:variable where @select contains user-defined types derived by restriction 
   ...
   <xslt:variable name="var1"
                  select="/my:anyUri-main/au1-anyURI-enumeration"
                  as="xs:string"/>

   <xslt:variable name="var2"
                  select="/my:anyUri-main/au2-anyURI-length"
                  as="xs:string"/>

   <xslt:variable name="var3"
                  select="/my:anyUri-main/au3-anyURI-minLength-pattern"
                  as="xs:string"/>

   <xslt:variable name="var4"
                  select="/my:anyUri-main/au4-anyURI-maxLength-whiteSpace"
                  as="xs:string"/>

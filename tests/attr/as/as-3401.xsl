   ...
   <xslt:template match="/my:docid">
      <out>
         ...
         <var1>
            ...
            <xslt:value-of select="nmtoken-elem/@my:toks instance of attribute(my:toks, xs:NMTOKENS)"/>
         </var1>
         <xslt:text>
</xslt:text>
         <var2>
            <xslt:value-of select="$var2 instance of attribute(my:entities, xs:ENTITIES)"/>
            <xslt:value-of select="entity-elem/@my:entities instance of attribute(my:entities, xs:ENTITIES)"/>
         </var2>
         <xslt:text>
</xslt:text>
         <var3>

...
<out>
<xsl:apply-templates>
	<xsl:with-param name="par1" select="/doc-schemaas/elem-NMTOKEN" as="xs:NMTOKEN" tunnel="no"/>
	<xsl:with-param name="par2" select="/doc-schemaas/elem-int" as="xs:int" tunnel="no"/>
	<xsl:with-param name="par3" select="/doc-schemaas/elem-nonPositiveInteger" as="xs:nonPositiveInteger" tunnel="no"/>
	<xsl:with-param name="par4" select="/doc-schemaas/elem-long" as="xs:long" tunnel="no"/>
	<xsl:with-param name="par5" select="/doc-schemaas/elem-unsignedByte" as="xs:unsignedByte" tunnel="no"/>
	<xsl:with-param name="par6" select="/doc-schemaas/elem-ID-attr/@attr1" as="xs:ID" tunnel="no"/>
</xsl:apply-templates>
</out>
</xsl:template>

...
<!-- Purpose: Test type of global xsl:variable where @select contains user-defined types derived by 
   ...
   <xslt:variable name="var1"
                  select="/my:userNode/my:de1-decimal-enumeration-inline"
                  as="xs:float"/>

   <xslt:variable name="var2"
                  select="/my:userNode/my:de2-decimal-maxExclusive-inline"
                  as="xs:float"/>

   <xslt:variable name="var3"
                  select="/my:userNode/my:de3-decimal-maxInclusive-minExclusive-inline"
                  as="xs:float"/>

   <xslt:variable name="var4"
                  select="/my:userNode/my:de4-decimal-minInclusive-pattern-inline"
                  as="xs:float"/>
   ...
   <xslt:template match="/my:userNode">
      <out>
         ...
         <var3>
            <xslt:value-of select="$var3 instance of my:de3-decimal-maxInclusive-minExclusive-Inline"/>

...
<xslt:transform xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:my="http://www.mytest.net"
   ...
   <xslt:variable name="var4" select="xs:dateTime('9999-05-31T13:20:00+14:00')"
      as="xs:anyAtomicType"/>
   ...
   <xslt:variable name="var9" select="xs:gYearMonth('6999-05+14:00')" as="xs:anyAtomicType"/>
   ...
   <xslt:variable name="var12" select="xs:gYear('2005')" as="xs:anyAtomicType"/>
   ...
   <xslt:variable name="var16" select="xs:gDay('---31Z')" as="xs:anyAtomicType"/>

   <xslt:variable name="var17" select="xs:gMonth('--05+14:00')" as="xs:anyAtomicType"/>

   <xslt:variable name="var18" select="xs:gMonth('--05')" as="xs:anyAtomicType"/>

   <xslt:variable name="var19" select="xs:boolean('true')" as="xs:anyAtomicType"/>

   <xslt:variable name="var20" select="xs:base64Binary('PM24')" as="xs:anyAtomicType"/>

   <xslt:variable name="var21" select="xs:hexBinary('07FF')" as="xs:anyAtomicType"/>

   <xslt:variable name="var22" select="xs:float(1.1234E99)" as="xs:anyAtomicType"/>

   <xslt:variable name="var23" select="xs:float(-1.75e-3)" as="xs:anyAtomicType"/>

   <xslt:variable name="var24" select="xs:decimal(-3.420100)" as="xs:anyAtomicType"/>

   <xslt:variable name="var25" select="xs:decimal(7.8899)" as="xs:anyAtomicType"/>

   <xslt:variable name="var26" select="xs:decimal(0.0)" as="xs:anyAtomicType"/>

   <xslt:variable name="var27" select="xs:double(5.4321E-1001)" as="xs:anyAtomicType"/>

   <xslt:variable name="var28" select="xs:double(-0.0E0)" as="xs:anyAtomicType"/>

   <xslt:variable name="var29" select="xs:double('INF')" as="xs:anyAtomicType"/>

   <xslt:variable name="var30" select="xs:integer(43)" as="xs:anyAtomicType"/>

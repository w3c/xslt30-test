...
<xsl:template match="/">
	<xsl:for-each select="*/IndividualRec">
		<xsl:result-document href="{$dir}/validation-0202-out/{@Id}.html" validation="strict" encoding="iso-8859-1">
			<xsl:apply-templates select="."/>
		</xsl:result-document>
	</xsl:for-each>
    <xsl:result-document href="{$dir}/validation-0202-out/index.html" validation="strict" encoding="iso-8859-1">

...
<xslt:transform xmlns:xs="http://www.w3.org/2001/XMLSchema"
                ...
                version="2.0">
<!-- Purpose: Test with xsl:stylesheet and @input-type-annotations="preserve". Show that 
  				all element and attribute nodes preserve their type annotations. All nodes 
  				are of built-in schema types if validated.-->

...
<!-- Purpose: Show that type annotations in temporary trees or element and attribute nodes  constructed in the 
   ...
   <xslt:variable name="var">
	     <complex-derived xmlns:xsl="http://www.w3.org/1999/XSL/Transform">21my:personType<firstName>John</firstName>
   ...
   <xslt:template match="/doc">
      <xslt:text>
         ...
         <out1>
            ...
            <xslt:value-of select="$var/complex-derived/@age instance of attribute(*, xs:untypedAtomic)"/>
         </out1>
         <xslt:text>
</xslt:text>
         <out2>
         ...
         <out3>{$var2}<xslt:value-of select="$var2 instance of attribute(*, xs:integer)"/>

...
<xslt:transform xmlns:xs="http://www.w3.org/2001/XMLSchema"
   xmlns:my="http://www.example.com/ns/test" xmlns:xslt="http://www.w3.org/1999/XSL/Transform"
   exclude-result-prefixes="xs my" input-type-annotations="strip" version="2.0">
   <!-- Purpose: Show that when @input-type-annotations="strip", is-id and is-idref 
  				properties of element and attribute nodes are preserved.-->

   <xslt:template match="/doc-id">
      <out>
         <E0>
            <xslt:value-of select="data(id-elem[1]) instance of xs:ID"/>
         </E0>

...
<xslt:transform xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   exclude-result-prefixes="xs my" input-type-annotations="unspecified" version="2.0">
   <!-- Purpose: Test that type annotations are stripped from the initial source tree if an included stylesheet has 
  				@input-type-annotations="strip". The primary stylesheet has @input-type-annotations="unspecified".-->

   <xslt:include href="import_strip.xsl"/>

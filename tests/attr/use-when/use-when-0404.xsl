...
<xslt:transform xmlns:xs="http://www.w3.org/2001/XMLSchema"
                ...
                version="2.0">
<!-- Purpose: Test case that uses use-when with an EBV of false on an xsl:choose instruction.
  				All of the xsl:when and xsl:otherwise instructions will be excluded as a result. -->

   <xslt:variable name="x" as="xs:string" select="'error'"/>

   <xslt:template match="doc">   
		    <out>
         <xslt:choose use-when="false()">

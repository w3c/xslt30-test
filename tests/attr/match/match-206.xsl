...
<xslt:transform xmlns:my="http://www.example.com/ns/match/var"
   xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns="http://www.example.com/ns/match/var"
   xmlns:xslt="http://www.w3.org/1999/XSL/Transform" exclude-result-prefixes="my xs" version="2.0">
   <!-- Purpose: Test of template matching with attribute($name ,$type) where $name has no prefix. Show there is no 
  				effect of default namespace of stylesheet on $name.-->

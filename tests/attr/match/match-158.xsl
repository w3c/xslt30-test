...
<!-- Purpose: Test of template matching with union of several schema-element($name) with 
   ...
   <xslt:template match="schema-element(my:simpleBuiltin)|schema-element(my:simpleUserElem)|schema-element(my:simpleUserList)|schema-element(my:simpleUserUnion)">

...
<!-- Purpose: Test of select in xsl:apply-templates with forExpr -->
   ...
   <xslt:template match="doc">
		    <out>
         <t1>
            <xslt:apply-templates select="(for $rep in ./* return $rep/descendant-or-self::*)[$var] "/>
         </t1>
         <t2>
            <xslt:apply-templates select="(for $rep in ./* return $rep/descendant-or-self::*)[child::element()] "/>
         </t2>
      </out>
	  </xslt:template>
